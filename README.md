...
EQ_SESSION_TIMEOUT - The duration of the flask session
EQ_SESSION_TIMEOUT_GRACE_PERIOD - The grace period between when the server removes the session and what we tell the client
